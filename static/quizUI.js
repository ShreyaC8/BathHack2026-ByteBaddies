...
music_options.forEach(label => {
    ...
    music_btn.addEventListener("click", () => {
        music_btn.classList.toggle("selected");
    });
...
book_options.forEach(label => {
    ...
    book_btn.addEventListener("click", () => {
        book_btn.classList.toggle("selected");
    });
...
movie_options.forEach(label => {
    ...
    movie_btn.addEventListener("click", () => {
        movie_btn.classList.toggle("selected");
    });
...
cuisine_options.forEach(label => {
    ...
    cuisine_btn.addEventListener("click", () => {
        cuisine_btn.classList.toggle("selected");
    });
...
dietry_options.forEach(label => {
    ...
    dietry_btn.addEventListener("click", () => {
        dietry_btn.classList.toggle("selected");
    });
...
hobby_options.forEach(label => {
    ...
    hobby_btn.addEventListener("click", () => {
        hobby_btn.classList.toggle("selected");
    });
